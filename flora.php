...
<?php include 'articleheader.php'; ?>
    ...
    <p>
        The Cooleman Ridge Nature Reserve has a suprisingly diverse range of flora on it. There are currently over 300 species that have been found on the ridge, with the majority of them being native to the ridge. You can view a full list of plants that have been identified on the ridge on our <a href="plants.php">Plant Survey</a> page.
    </p>

     <p>
        The quality of different sections ranges from very poor to very good. <a href="weeds.php">Weeds</a> still form a major part of the ridge, both in terms of their type and coverage.. the balance between very good to very good.

        and bad areas has significantly moved towards the good over the approximately 25 history of the group. In contrast, the best areas of the ridge are generally been covered by our <a href="groupareas.php">Group Areas</a>. Many high quality areas also exist outside of the group areas.

    </p>

    <p>
        Detailed information about plants found on the ridge can often be found in our monthly newsletter. The articles are about both the native and exotic plants. Please see our <a href="news.php">News</a> page for more information.
    </p>

    <p>
        The group conducts various surveys that relate to the flora found on the ridge. This include the <a href="plants.php">Plant Survey</a>, the <a href="trees.php">Tree Survey</a> and the <a href="blackberrys.php">Blackberry Survey</a>. These surveys serve many purposes from management through to simple interest.
    </p>

<p>The following is a list of some of the more common and or easily identified native species found on the ridge. The list intended to provide people who are unfamiliar with the native flora on the ridge a gentle introduction to the dominant native flora found on the ridge. These species are relatively easy to identify, even for a novice. The list is by no means complete. </p>
...
<div class="panel panel-success">
    ...
    <div class="panel-body">
        ...
        <p>
            Spear Grass is common on the ridge. It is naturally recovering since grazing has been removed.
        </p>
...
<div class="panel panel-success">
    ...
    <div class="panel-body">
        ...
        <p>
            Narrawa Burr is quite common on the ridge and evenly dispersed.
        </p>
...
<div class="panel panel-success">
    ...
    <div class="panel-body">
        ...
        <p>
            ...
            Blackthorn performs many important ecological functions on the ridge such as being a habit for insects and birds that feed on insects that attach larger plants such as Red Gum.
        <p>
