...
<?php include 'header.php'; ?>
    ...
    <p>
        The group holds an annual general meeting every October. The primary purpose of the meeting is to elect the <a href="structure.php">committee members</a> for the forthcoming year.
    </p>
