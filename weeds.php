...
<?php include 'header.php'; ?>
    ...
    <div class="panel panel-success">
        <div class="panel-heading">Canary Grass <em>(Phalaris aquatica)</em></div>
        <div class="panel-body">
    ...
    <div id="aaronsrod" class="panel panel-success">
    ...
    <div id="wildsage" class="panel panel-success">
    ...
    <div id="stjohnswort" class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <p>
                St Johns Wort is a major problem on the ridge. Its presence has increase significantly in recent years and the ridge now has large infestations of it. It is most common on the wetter and cooler south western slopes of the ridge above the various horse paddocks.
            </p>
    ...
    <div id="africanlovegrass" class="panel panel-success">
    ...
    <div id="pattersonscurse" class="panel panel-success">
    ...
    <div  id="beardedoats" class="panel panel-success">
    ...
    <div id="sweet briar" class="panel panel-success">
    ...
    <div id="fleabane" class="panel panel-success">
    ...
    <div id="scotchthistle" class="panel panel-success">
